...
export default function AboutUs() {
  ...
  return (
    <>
      <section
        className="relative z-10 w-screen h-[calc(100vh-160px)] max-w-7xl mx-auto"
        id="home"
      >
        <div className="flex items-center justify-center h-full w-full">
          ...
          <div className="relative w-full max-w-4xl flex items-center justify-center">
            ...
            <div className="inset-0 flex flex-col items-center justify-center text-center text-white px-4 space-y-6 z-30">
              <h1
                className={`logo xl:text-8xl md:ml-2 sm:text-5xl md:text-7xl text-5xl font-ruda text-neon-yellow mb-2`}
              >
                <b className="w-1/2">
              ...
              <div
                className="absolute flex flex-col text-white items-center space-y-2 z-10"

        ...
        <section className="relative md:h-screen w-full overflow-hidden p-5 max-w-7xl mx-auto" id="conuhacks">
            ...
            <div className="relative z-10 md:h-full w-full flex md:px-4 lg:px-10 md:py-25 mx-auto max-w-7xl min-h-[70vh]">
                <div className="text-white">
                    ...
                    <p className="text-xs md:text-sm max-w-5xl mb-5" dangerouslySetInnerHTML={{ __html: activeSlide.subtitle }}></p>
                    {
                        activeSlide.stats && (
                            <div className="grid grid-cols-4 gap-4 text-sm max-w-sm" style={{ marginTop: '0px' }}>

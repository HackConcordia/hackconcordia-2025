...
export const getUpcomingEvents = (t: TranslationObject): Event[] => [
    // FALL 2025
    {
        ...
        year: '2025',
        title: t.UpcomingEvents.events[3].title,
        type: t.UpcomingEvents.events[3].type,
        time: t.UpcomingEvents.time.eveningTime,
        location: t.UpcomingEvents.address.threeB,
        address: t.UpcomingEvents.address.threeB_address,
        highlight: true,
    },
    {
        id: 1,
    ...
    //     id: 2,
    //     date: '30',
    //     month: t.UpcomingEvents.months.September,
    //     year: '2025',
    //     title: t.UpcomingEvents.events[2].title,
    //     type: t.UpcomingEvents.events[2].type,
    //     time: t.UpcomingEvents.time.evening,
    //     location: t.UpcomingEvents.address.reggies,
